...
Drop the following files in this folder. The site will pick them up automatically.

| File | Purpose | Recommended size |
| ---- | ------- | ---------------- |
| `logo.png`           | Tiger + RED T7GER wordmark — header brand mark, OG / social preview | 1024×1024, transparent or black bg |
...
Do not put unreleased / private artwork here. This folder is shipped publicly with the site.
